...
**Current status:** v1 signed off on 2026-04-28 after Shadow HITL closure, detached runtime validation, responsive remediation, confirmation of URL ingest SSRF protection already present in code, baseline live Exa validation for curated Polish research queries, and post-v1 threshold calibration on local repo data (defaults retained; follow-up drift SQLite↔Chroma noted).
